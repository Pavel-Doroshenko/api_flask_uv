Проект предназначен для ознакомления с возможностью создания приложения по технологии REST API, реализующий методы CRUD (создание, чтение, обновление, удаление) 
